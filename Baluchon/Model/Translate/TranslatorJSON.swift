...
typealias taLang = (code: String, language: String, flag: UIImage, country: String)
...
// World icon and name for buttons
class WorldLanguages {
    let worldLanguages: [taLang] = [
        ("af", "Afrikaans", #imageLiteral(resourceName: "south-africa"), "south-africa.png"),("sq", "Albanian", #imageLiteral(resourceName: "albania"), "albania.png"), ("am", "Amharic", #imageLiteral(resourceName: "ethiopia"), "ethiopia.png"), ("ar", "Arabic", #imageLiteral(resourceName: "united-arab-emirates"), "united-arab-emirates.png"),("hy", "Armenian", #imageLiteral(resourceName: "armenia"), "armenia.png"), ("az", "Azerbaijani", #imageLiteral(resourceName: "azerbaijan"), "azerbaijan.png"),("eu", "Basque", #imageLiteral(resourceName: "basque-country"), "basque-country.png"), ("be", "Belarusian", #imageLiteral(resourceName: "belarus"), "belarus.png"), ("bn", "Bengali", #imageLiteral(resourceName: "bangladesh"), "bangladesh.png"), ("bs", "Bosnian", #imageLiteral(resourceName: "bosnia-and-herzegovina"), "bosnia-and-herzegovina.png"), ("bg", "Bulgarian", #imageLiteral(resourceName: "bulgaria"), "bulgaria.png"), ("ca", "Catalan", #imageLiteral(resourceName: "spain"), "spain.png"), ("ceb", "Cebuano", #imageLiteral(resourceName: "philippines"), "philippines.png"), ("zh-CN", "Chinese (Simplified)", #imageLiteral(resourceName: "china"), "china.png"), ("zh-TW", "Chinese (Traditional)", #imageLiteral(resourceName: "china"), "china.png"), ("co", "Corsican", #imageLiteral(resourceName: "corsica"), "corsica.png"), ("hr", "Croatian", #imageLiteral(resourceName: "croatia"), "croatia.png"), ("cs", "Czech", #imageLiteral(resourceName: "czech-republic"), "czech-republic.png"), ("da", "Danish", #imageLiteral(resourceName: "denmark"), "denmark.png"),("nl", "Dutch", #imageLiteral(resourceName: "netherlands"), "netherlands.png"), ("en", "English", #imageLiteral(resourceName: "united-kingdom"), "united-kingdom.png"), ("eo", "Esperanto", #imageLiteral(resourceName: "nigeria"), "nigeria.png"), ("et", "Estonian", #imageLiteral(resourceName: "estonia"), "estonia.png"), ("fi", "Finnish", #imageLiteral(resourceName: "finland"), "finland.png"), ("fr", "French", #imageLiteral(resourceName: "france"), "france.png"), ("fy", "Frisian", #imageLiteral(resourceName: "netherlands"), "netherlands.png"),("gl", "Galician", #imageLiteral(resourceName: "spain"), "spain.png"), ("ka", "Georgian", #imageLiteral(resourceName: "georgia"), "georgia.png"), ("de", "German", #imageLiteral(resourceName: "germany"), "germany.png"), ("el", "Greek", #imageLiteral(resourceName: "greece"), "greece.png"), ("gu", "Gujarati", #imageLiteral(resourceName: "india"), "india.png"), ("ht", "Haitian Creole", #imageLiteral(resourceName: "haiti"), "haiti.png"), ("ha", "Hausa", #imageLiteral(resourceName: "nigeria"), "nigeria.png"), ("haw", "Hawaiian", #imageLiteral(resourceName: "hawaii"), "hawaii.png"), ("he", "Hebrew", #imageLiteral(resourceName: "israel"), "israel.png"), ("hi", "Hindi", #imageLiteral(resourceName: "india"), "india.png"),("hmn", "Hmong", #imageLiteral(resourceName: "spain"), "spain.png"), ("hu", "Hungarian", #imageLiteral(resourceName: "hungary"), "hungary.png"), ("is", "Icelandic", #imageLiteral(resourceName: "iceland"), "iceland.png"), ("ig", "Igbo", #imageLiteral(resourceName: "nigeria"), "nigeria.png"), ("id", "Indonesian", #imageLiteral(resourceName: "monaco"), "monaco.png"), ("ga", "Irish", #imageLiteral(resourceName: "ireland"), "ireland.png"), ("it", "Italian", #imageLiteral(resourceName: "italy"), "italy.png"), ("ja", "Japanese", #imageLiteral(resourceName: "japan"), "japan.png"), ("jw", "Javanese", #imageLiteral(resourceName: "monaco"), "monaco.png"), ("kn", "Kannada", #imageLiteral(resourceName: "india"), "india.png"),
